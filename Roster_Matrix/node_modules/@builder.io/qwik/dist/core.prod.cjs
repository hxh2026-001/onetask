...
!function(global, factory) {
    ...
    const ResourceSerializer = /*#__PURE__*/ serializer({
        ...
        $fill$: (resource, getObject) => {
            if ("resolved" === resource._state) {
                if (resource._resolved = getObject(resource._resolved), (value => {
                    ...
                    resource._state = "rejected", resource._error = err, resource._resolved = void 0, 
                    resource.loading = !1, resource.value = createHandledRejectedPromise(err);
                } else {
                    resource.value = Promise.resolve(resource._resolved);
                }
            } else {
                "rejected" === resource._state && (resource._error = getObject(resource._error), 
    ...
    const injectQContainer = containerEl => {
        directSetAttribute(containerEl, "q:version", "1.20.0"), directSetAttribute(containerEl, "q:container", "resumed"), 
    ...
    globalThis.__qwik_reg_symbols.set(hash, symbol), symbol), exports._renderSSR = async (node, opts) => {
        ...
        containerAttributes["q:container"] = "paused", containerAttributes["q:version"] = "1.20.0", 
    ...
    exports.useVisibleTaskQrl = useVisibleTaskQrl, exports.version = "1.20.0", exports.withLocale = function(locale, fn) {
