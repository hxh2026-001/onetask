...
const dbPath = join(__dirname, "../../data/typeface.db");
...
export const insertTypeface = db.prepare(`
  INSERT INTO typefaces (name, glyphs, metrics) VALUES (?, ?, ?)
`);

export const getAllTypefaces = db.prepare(`
  SELECT * FROM typefaces
`);

export const insertComposition = db.prepare(`
  INSERT INTO composition_history (content, settings) VALUES (?, ?)
`);

export const getAllCompositions = db.prepare(`
